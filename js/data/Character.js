...
, spell); } else { this.applyBuff(this, spell); } }
    castDebuffSpell(spell, targets) { if (Array.
isArray(targets)) { targets.forEach(target => { if (target && target.isAlive) this.applyDebuff(target, spell); }); } else if (targets) { this.applyDebuff(targets, spell); } }
